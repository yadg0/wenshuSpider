...
public class SpiderBeanFactory {
	...
	public static void main(String[] args) {
		String url="http://wenshu.court.gov.cn/List/List?sorttype=1&conditions=searchWord+1+AJLX++案件类型:刑事案件";
		String ur1="http://wenshu.court.gov.cn/List/List?sorttype=1&conditions={sort}";
		Map<String, String> params = UrlMatcher.match(url, ur1);
